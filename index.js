...
*/
const XPTN = 'Ghalyh Bot'; // JANGAN DI UBAH NNTI EROR
const instagram = 'https://instagram.com/ghlyhalamn'; // JANGAN DI UBAH NNTI EROR
const nomer = 'http://wa.me/+6285766853909'; // JANGAN DI UBAH NANTI EROR
const aktif = 'Sesuai Selera'; // DI GANTI AUTO EROR
const groupwa = 'https://chat.whatsapp.com/G3yYhho2lz4D3UiruLHp1M'; // DI GANTI AUTO EROR
const youtube = 'gak ada'; // DI GANTI AUTO EROR
//
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Ghalyh Bot Ready scan now/scan sekarang Ngentod!`);
});
...
conn.sendMessage(id, 'Owner Ghalyh Bot http://wa.me/+6285766853909' ,MessageType.text);
}
else if (text == 'Galih'){
conn.sendMessage(id, 'aku pembuat Ghalyh Bot' ,MessageType.text);
}
else if (text == 'chichi'){
conn.sendMessage(id, 'pacar Ghalyh' ,MessageType.text);
}
...
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA http://wa.me/+6285766853909* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh #help' ,MessageType.text);
}
...
conn.sendMessage(id, 'kawan2 testing script wa.me/+6285766853909' ,MessageType.text);
}
else if (text == '.groupbot'){
conn.sendMessage(id, 'group bot whatsapp https://chat.whatsapp.com/G3yYhho2lz4D3UiruLHp1M' ,MessageType.text);
}
else if (text == '.tools1'){
...
conn.sendMessage(id, 'Terima kasih telah  Menggunakan BOT GHALYH BOT dengan bijak , Jangan lupa follow Instagram Mimin Yah😋 : https://instagram.com/ghlyhalamn' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, 'Terima kasih telah  Menggunakan BOT GHALYH BOT dengan bijak , Jangan lupa follow Instagram Mimin Yah😋 : https://instagram.com/ghlyhalamn' ,MessageType.text);
}
